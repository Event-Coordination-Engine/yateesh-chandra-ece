...
class Event(Base):
    ...
    event_attendee = relationship('Attendee',
...
# Create class for Backup of Attendees
...
# Create a Backup Table for event such that Even after the Event is deleted,
# It stays here in Backup
...
# Create a Relation to track event operations
...
# Create an Audit to get API Calls
